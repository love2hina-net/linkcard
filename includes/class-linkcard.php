...
class Linkcard {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Linkcard_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Linkcard_Loader. Orchestrates the hooks of the plugin.
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-linkcard-loader.php';
		...
		$this->loader = new Linkcard_Loader();
	 ...
	 *
	 * @since     1.0.0
	 * @return    Linkcard_Loader	Orchestrates the hooks of the plugin.
	 */
